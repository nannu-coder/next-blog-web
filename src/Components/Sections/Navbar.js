...
const navigation = [
  ...
  { name: "Style Guide", href: "/style", current: false },
...
const Navbar = () => {
  return (
    <Disclosure as="nav" className="container mx-auto">
      {({ open }) => (
        <>
          <div className="px-2 sm:px-6 lg:px-8 bg-white shadow-cs mt-4 rounded-xl">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Link
                  href="/signin"
                  className="bg-[#FB2576] px-8 py-2 rounded-full text-white font-medium"
                >
                  Sign in
                </Link>
              </div>
